...
addpath('/data4/nbusch/Corenats_2022/code/analysis/functions/')%addpath('./functions/') %/data4/nbusch/Corenats_2022/code/analysis/functions

eeglab_path = '/data4/nbusch/Corenats_2022/code/tools/eeglab2021.0/';
