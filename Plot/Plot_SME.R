...
## Frontal ##
#load data
SEM_frontal <- read.csv('/Volumes/aebusch/nbuschgold/ecesnait/Corenats/2024/Matlab code/Output/SEM_frontal.csv')
SEM_no_time <- SEM_frontal[,-1]
...
# plot
tiff("/Volumes/aebusch/nbuschgold/ecesnait/Corenats/2024/R/Figures/SME_frontal.png", units="in", width=5, height=3.8, res=150)
...
# plot
tiff("/Volumes/aebusch/nbuschgold/ecesnait/Corenats/2024/R/Figures/SME_parietal.png", units="in", width=5, height=3, res=150)
