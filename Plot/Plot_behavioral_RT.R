...
RT_press <- RT_press[-14,] # remove the outlier
...
RT_lag_pres_2 <- RT_lag_pres_2[-1,-14]# remove the first presentation with no lag and the outlier participant
...
RT_lag_pres_3 <- RT_lag_pres_3[-1,-14] # remove the first presentation with no lag and the outlier participant
