...
indx_rm_v1 <- which(long_RT_lag2$lag == 'V1') # remove the first repetition since there was no lag
...
RT_lag_pres_3 <- RT_lag_pres_3[,-14] # remove outlier
...
indx_rm_v1 <- which(long_RT_lag3$lag == 'V1') # remove the first presentation since there was no lag
